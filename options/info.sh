...
Isadmin=$(curl -sS https://raw.githubusercontent.com/sanusi277/permission/main/ip | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/sanusi277/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
